        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsersLimit = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Logo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TrialExpiry = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPhoneCallAllowed = table.Column<bool>(type: "bit", nullable: false),
                    IsEmailAllowed = table.Column<bool>(type: "bit", nullable: false),
                    IsTextAllowed = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Post_reactions_like_total = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Post_engaged_users = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Post_impressions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Post_clicks = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InsightsId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_PostInsights_InsightsId",
                        column: x => x.InsightsId,
                        principalTable: "PostInsights",
                        principalColumn: "Id",
